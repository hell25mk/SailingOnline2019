    ...
    public class MatchGameStartTimer : MonoBehaviourPunCallbacks
    {
        ...
        void Start()
        {
            ...
            if (PhotonNetwork.IsMasterClient)
            {
                ...
                properties.Add(CustomPropertyKey.InRoomLimitTime, PhotonNetwork.Time);
                PhotonNetwork.CurrentRoom.SetCustomProperties(properties);
            }

            gameStartCount = (double)PhotonNetwork.CurrentRoom.CustomProperties[CustomPropertyKey.InRoomLimitTime];
        }
